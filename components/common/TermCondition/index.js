  ...
  return (
    <>
      ...
      <div className="lg:py-4 md:py-3 max-sm:py-2 lg:px-[4rem] md:px-[3rem] max-sm:px-[1rem]">
        ...
        <br />
        <p>
          These terms and conditions applies to the javaSpringBoot app (hereby
          referred to as "Application") for mobile devices that was created by
          Manish kumar (hereby referred to as "Service Provider") as a Free
          service.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>These terms and conditions are effective as of 2024-12-22</p>
        <br />
