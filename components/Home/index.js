...
export default function HomePage() {
  return (
    <>
      <main className="w-full flex max-sm:flex-col justify-between items-center mx-auto lg:py-4 md:py-3 max-sm:py-2 lg:px-[4rem] md:px-[2rem] max-sm:px-[1rem]">
      ...
      <div className="lg:py-4 md:py-3 max-sm:py-2 lg:px-[4rem] md:px-[3rem] max-sm:px-[1rem] mt-[1rem]">
        ...
        <ol className="list-decimal pl-6 space-y-2 ml-6 mb-2 text-gray-800">
          <li>
            Each player will be having one color and four tokens of that color.{" "}
          </li>
          <li>Red color determine the starting player.</li>
          <li>
            Players must roll a 6 to move their tokens out of the starting area
            and onto the board.
          </li>
          <li>
          ...
          <li>
            If a token lands on a safe space (marked with a star), it cannot be
            captured.
          </li>
          <li>
            The first player to move all four tokens into the home area wins the
            game.
          </li>
        </ol>
      </div>
      <div className="lg:py-4 md:py-3 max-sm:py-2 lg:px-[4rem] md:px-[3rem] max-sm:px-[1rem] mt-[1rem]">
        <h1 className="text-2xl font-bold text-center text-[#2d78a1] mb-4">
          How to Install Zysom App
        </h1>
        <div className="pl-3 text-gray-800 mb-2">
          Steps to install the Zysom app and start playing
        </div>
        <ol className="list-decimal pl-6 space-y-2 ml-6 mb-2 text-gray-800">
          <li>Click “Download App” to access Zysom App for Android. </li>
          <li>
            Tap “Download Anyway” on the general warning message. Zysom is 100%
            secure.
          </li>
          <li>
          ...
          <li>
            Go to settings and Allow from this source. All files from our source
            are safe.
          </li>
        </ol>
